...
document.addEventListener('DOMContentLoaded', () => {
  const options = document.querySelectorAll('.loop-subscription-group, .loop-one-time-purchase-option');
  ...
  const checkedOption = document.querySelector('input[name="loop_purchase_option"]:checked');
  if (checkedOption) {
    checkedOption.parentElement.classList.add('selected');
  }
});
